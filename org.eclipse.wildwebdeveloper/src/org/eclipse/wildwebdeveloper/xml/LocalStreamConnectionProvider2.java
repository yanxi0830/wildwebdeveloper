...
public abstract class LocalStreamConnectionProvider2 implements StreamConnectionProvider {
	 ...
	 */
	protected LocalStreamConnectionProvider2(ILog log, String pluginId) {
		this.log = log;
	...
	public static abstract class LocalServer {
		 ...
		 */
		public void stop() {
			System.out.println("LocalServer STOP");
